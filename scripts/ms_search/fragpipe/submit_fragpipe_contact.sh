...
#SBATCH --job-name=fragpipe_contact
#SBATCH --output=/scratch/leduc.an/AAS_Evo/logs/fragpipe_contact_%A_%a.out
#SBATCH --error=/scratch/leduc.an/AAS_Evo/logs/fragpipe_contact_%A_%a.err
...
FASTA_DIR="${DATA_DIR}/FASTA/per_plex_contact_fragpipe"
...
FRAGPIPE_TOOLS="${FRAGPIPE_TOOLS:-/home/leduc.an/bin/fragpipe-24.0/tools}"
export JAVA_HOME="${JAVA_HOME:-/home/leduc.an/bin/jdk-17.0.18+8}"
# --------------------------
...
OUTDIR="${SEARCH_DIR}/results_contact/${PLEX_ID}"
